---
subtitle: Humanloop is the Integrated Development Environment for Large Language Models
---
...
![Humanloop's IDE for LLMs helps teams prompt engineer and evaluate LLM use-cases](https://files.readme.io/5f4671a-Welcome_image.png)
</Frame>
</Bleed>
...
You can learn more about the challenges of AI development and how Humanloop solves them in [Why Humanloop?](./why-humanloop).
