...
- A [project](../create-project/overview) in Humanloop
- A [dataset](./create-dataset) in that project

## Create a model config

It's important that the model config we use to perform the batch generation is consistent with the dataset. We're going to use the simple customer support dataset that we uploaded in the previous [Create a dataset guide](./create-dataset). As a reminder, the dataset looks like this
