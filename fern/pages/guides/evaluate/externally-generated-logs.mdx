...
3. You need to have a dataset in your project. See our dataset creation guide if you don't yet have one.
4. You need to have a model config that you're trying to evaluate - create one in the Editor.
...
Alternatively, if your model config lives outside the Humanloop system, you can post it to Humanloop with the [register model config endpoint](https://docs.humanloop.com/reference/modelconfigs_register).
...
<Frame>
![](https://files.readme.io/d16f62b-image.png)
</Frame>
