...
<img src="../../../assets/images/29c3a3f-image.png" alt="Selecting the type of a new evaluator" />
...
<img src="../../../assets/images/4235b31-image.png" alt="The evaluator editor after selecting **Valid JSON** preset" />
...
<img src="../../../assets/images/7330b9d-image.png" alt="The debug console (you can resize this area to make it easier to view the logs)" />
...
<img src="../../../assets/images/c3d9b08-image.png" alt="The **Valid JSON** evaluator returned `True` for this particular log, indicating the text output by the model was grammatically correct JSON." />
...
<img src="../../../assets/images/71c34c5-image.png" alt="Activating the new evaluator to run automatically on your project." />
