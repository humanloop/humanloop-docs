...
<Info title="API Options">
  This guide uses our [Python SDK](/docs/reference/sdks). All of the endpoints
  used are available in our [TypeScript SDK](/docs/reference/sdks) and directly
  [via the API](/docs/reference/humanloop-api).
</Info>
hu ### Install and initialize the SDK
