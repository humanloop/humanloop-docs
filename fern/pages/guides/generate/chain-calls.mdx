---
subtitle: This guide explains how to use sequences of LLM calls to achieve a task in Humanloop. Humanloop allows you to trace through these "sessions", enabling you to troubleshoot where your LLM chain went wrong or track sequences of actions taken by your LLM agent.
---
