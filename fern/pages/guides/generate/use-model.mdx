...
You already have a project created - if not, please pause and first follow our [project creation](doc:create-a-project-from-the-playground) guides.
...
### The process of capturing feedback then uses the returned `data_id` as before.  
   See our [guide to recording feedback with the SDK](doc:generate-and-log-with-the-sdk).
