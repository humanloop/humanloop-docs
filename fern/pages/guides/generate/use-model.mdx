...
You already have a project created - if not, please pause and first follow our [project creation](./create-a-prompt-in-the-ui) guides.
...
See our [guide to recording feedback with the SDK](./guides/generate-and-log-with-the-sdk).
