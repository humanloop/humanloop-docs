...
The Humanloop Python SDK allows you to programmatically set up Humanloop projects with [model configs](../../core-entities/key-concepts#model-config) and a [feedback schema](../../core-entities/key-concepts#feedback).
...
With the project now set up, you can start to log generations from your models by following the [guide to logging generations using the SDK](../generate/overview).