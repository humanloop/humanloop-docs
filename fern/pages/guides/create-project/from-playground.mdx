...
Going from exploring in the Playground to a [Humanloop project](../../core-entities/key-concepts#projects) ready for integration into your application takes just a few clicks.
...
2. Enter a [prompt template](doc:key-concepts#prompt-templates) into the text box on the left of the page.
...
With the project set up, you can now integrate it into your app by following the [SDK/API integration guide](../generate/overview).