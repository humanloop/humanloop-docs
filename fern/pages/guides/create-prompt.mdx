...
Humanloop acts as a registry of your [Prompts](./prompts) so you can centrally manage all their versions and logs, and evaluate and improve your AI systems.
...
<Warning>Note: that Prompts are still called 'projects' in the SDK and versions of Prompts are called 'model configs'</Warning>
<Steps>
...
Go to the [Humanloop app](https://app.humanloop.com) and you will see your new project as a Prompt with with the model config you just created.
