...
- [API Reference Guide](https://humanloop.com/docs/v5/api-reference): Comprehensive documentation of Humanloop's API endpoints.
- [SDK Overview](https://humanloop.com/docs/v5/api-reference/sdks): Information on available SDKs for easier integration.
- [Tool Calling Guide](https://humanloop.com/docs/v5/development/guides/tool-calling): Learn how to extend Humanloop's functionality with custom tools.
- [Function Calling](https://humanloop.com/docs/v5/concepts/tools#tool-use-function-calling) via OpenAI: Integrate OpenAI's function calling feature with Humanloop.
