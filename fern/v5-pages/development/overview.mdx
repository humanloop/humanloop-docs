...
Type of Property (e.g., condo, house): {{property_type}}
Special Features (e.g., pool, garden, garage): {{special_features}}
Nearby Amenities (e.g., schools, parks, shopping centers): {{nearby_amenities}}
