...
[Environments](/docs/v5/concepts/environments) are a tagging system for deploying Prompts. They enable you to deploy maintain a streamlined deployment workflow and keep track of different versions of Prompts.
...
- You have multiple environments - if not first go through the [Create an
  environment](/docs/v5/development/guides/create-deployment-environments#create-an-environment) section.
