---
subtitle: A comprehensive guide on calling LLMs through the Humanloop API
...
This guide walks you through how to call various models through the Humanloop API. This is the same as [calling a Prompt](/docs/guides/prompt-management/call-prompt) but instead of using a version of the Prompt that is defined in Humanloop, you're setting the template and parameters directly in code.

The benefits of using the Humanloop proxy are:

- consistent interface across different AI providers: OpenAI, Anthropic, Google and more.
- logs all your requests automatically
...
<EndpointRequestSnippet endpoint="POST /prompts/call" example="With Prompt" />

<EndpointResponseSnippet endpoint="POST /prompts/call" example="With Prompt" />
