...
For more detailed instructions on how to link and manage tools, check out our guide on [Linking a JSON Schema Tool](/docs/v5/development/guides/link-json-schema-tool).
