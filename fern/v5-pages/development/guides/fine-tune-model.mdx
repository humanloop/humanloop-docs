...
- You already have a Prompt — if not, please follow our [Prompt creation](/docs/v5/development/guides/create-prompt) guide first.
...
guidelines](https://beta.openai.com/docs/v5/guides/fine-tuning):
