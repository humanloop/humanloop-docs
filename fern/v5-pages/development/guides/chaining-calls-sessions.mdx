---
subtitle: How to trace through "sessions" of LLM calls, enabling you to view the full context of actions taken by your LLM agent and troubleshoot issues.
...
<Tip>
  If you don't use Python, you can check out our [TypeScript SDK
  ](/docs/api-reference/sdks) for the corresponding endpoints.
</Tip>

<Warning>
  This guide is written for Python and API v4. It's yet to be updated
</Warning>
