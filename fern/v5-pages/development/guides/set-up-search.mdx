---
subtitle: Set up a RAG system using the Pinecone integration
...
<Note>
  ...
  embedding models](https://platform.openai.com/docs/v5/guides/embeddings), you
  can skip to section: **Setup Humanloop**
</Note>
...
# https://platform.openai.com/docs/v5/guides/embeddings/what-are-embeddings
...
We'll use the awesome [Hugging Face datasets](https://huggingface.co/docs/v5/datasets/load_hub) to source a demo dataset (following the [Pinecone quick-start guide](https://docs.pinecone.io/docs/v5/semantic-text-search)). In practice you will customise this step to your own use case.
