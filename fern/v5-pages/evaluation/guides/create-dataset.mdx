...
### Prerequisites
If you are using the the SDK, the only prerequisite is to have the SDK installed and configured. If you are using the API directly, you will need to have an API key and be familiar with the API.
