...
We must first define some sample data that contains user messages and desired responses from our [Support Agent Prompt](#create-a-dataset-from-logs) and call the `POST /datasets` endpoint to upload it as follows:
