...
[Datasets](/docs/v5/datasets) are a collection of input-output pairs that can be used to evaluate your Prompts, Tools or even Evaluators.

This guide will show you how to create Datasets in Humanloop in three ways:

- [Create a Dataset from existing Logs](#create-a-dataset-from-logs)
- [Upload data from CSV](#upload-data-from-csv)
