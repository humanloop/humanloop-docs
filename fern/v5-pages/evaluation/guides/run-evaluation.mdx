...
- At least one [Evaluator](../../concepts/evaluators) to judge the performance of the Prompts - see the guides on creating [Code](/docs/v5/evaluation/guides/code-based-evaluator), [AI](/docs/v5/evaluation/guides/llm-as-a-judge) and [Human](/docs/v5/evaluation/guides/human-evaluators) Evaluators.
...
- Setup Evaluations where the runtime for producing Logs lives in your code - see our guide on [Logging](/docs/v5/development/guides/log-to-a-prompt).
- Utilise Evaluations as part of your [CI/CD pipeline](/docs/v5/evaluation/guides/cicd-integration)
