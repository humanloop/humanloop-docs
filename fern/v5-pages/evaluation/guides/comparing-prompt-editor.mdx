...
You can compare Prompt versions interactively side-by-side to get a sense for how their behaviour differs; before then triggering more systematic [Evaluations](/docs/v5/evaluation/guides/run-evaluation).
All the interactions in Editor are stored as Logs within your Prompt and can be inspected further and [added to a Dataset](/docs/v5/evaluation/guides/create-dataset#create-a-dataset-from-logs) for Evaluations.
