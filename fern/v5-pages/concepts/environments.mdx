...
You can now call the version deployed in a specific environment by including an optional additional `environment` field. An exmaple of this field can be seen in the v5 [Prompt Call](/v5/api-reference/prompts/log#request.query.environment) documentation.
